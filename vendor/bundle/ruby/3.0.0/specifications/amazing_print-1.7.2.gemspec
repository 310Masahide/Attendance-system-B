# -*- encoding: utf-8 -*-
# stub: amazing_print 1.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/amazing-print/amazing_print/blob/master/CHANGELOG.md" } if s.respond_to? :metadata=
